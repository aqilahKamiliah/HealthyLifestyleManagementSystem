...
<div class="dashboard-container">
    <div class="dashboard-grid">
        ...
        <div class="dashboard-col">
            ...
            <span style="font-size: 13px; font-weight: bold; color: #555; display:block; margin-bottom: 10px;">
                Today
            </span>
            ...
            <div class="todo-section">
                ...
                <?php
                $sqlExercise = "
                SELECT activity, duration, intensity
                FROM exercise_logs
                WHERE client_id = '$client_id'
                AND date = CURDATE()
                ORDER BY log_id DESC
                ...
                <?php
                    ...
                    echo "<p>No exercise logged today.</p>";
                }
                ?>
        ...
        <div class="dashboard-col">
            <h3 class="card-title" style="text-align: left; font-size: 18px;">
...
?>
    ...
    <div class="ex-desc">
        <?= $today['duration']; ?> min, <?= $today['intensity']; ?> intensity
    </div>
</div>
...
?>
            ...
            <div class="exercise-card">
                ...
                <div class="ex-desc">
                    <?= $prev['date']; ?> — <?= $prev['duration']; ?> min, <?= $prev['intensity']; ?>
                </div>
            </div>
